...
```bash
wget [https://raw.githubusercontent.com/airdropalc/Union-Auto-Swap/refs/heads/main/union.sh](https://raw.githubusercontent.com/airdropalc/Union-Auto-Swap/refs/heads/main/union.sh) -O union.sh && chmod +x union.sh && ./union.sh
```
